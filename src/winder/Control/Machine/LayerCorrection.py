...
if __name__ == "__main__" :
  ...
  # rotation = 0.1
  # maxError = float( "-inf" )
  # layerDefault = DefaultLayerCalibration( None, None, "U" )
  # for _ in xrange( 0, 1500 ) :
  #   layer = layerDefault.copy()
  #   LayerError.rotate( layer, rotation )
  #   LayerError.addError( layer, 0.3, 1 )
  #   correction = LayerCorrection( layer )
  #   determinedRotation = correction.getRotation()
  #   rotationError = determinedRotation - rotation
  #
  #   maxError = max( maxError, abs( rotationError ) )
  #
  #   print rotationError, "\t", maxError, "     \r",
  #   sys.stdout.flush()
  ...
  for layer in [ 'X', 'V', 'U', 'G' ] :
    ...
    for _ in xrange( 0, 10 ) :
      ...
      #print rotation, determinedRotation

      assert( MathExtra.isclose( rotation, determinedRotation ) )